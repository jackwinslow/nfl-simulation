...
Commanders.set_healthy()
Commanders.set_draft_rank(10)
...
Buccaneers.set_healthy()
Buccaneers.set_draft_rank(9)
...
Cardinals.set_healthy()
Cardinals.set_draft_rank(22)
